...
export default function Pagination({
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row items-center justify-between w-full px-6 py-4 bg-white dark:bg-[#161B22] border-t border-gray-100 dark:border-[#2A2F3A] rounded-b-2xl select-none">
      <div className="flex-1 text-[15px] text-[#4b5563] dark:text-gray-300 font-medium text-left w-full md:w-auto">
      ...
      <div className="flex-1 flex justify-center w-full md:w-auto my-4 md:my-0">
        <div className="flex items-center border border-[#e5e7eb] dark:border-[#2A2F3A] rounded-lg overflow-hidden bg-white dark:bg-[#0B0D12] shadow-xs">
          <span className="px-3 py-1.5 text-[15px] text-[#6b7280] dark:text-gray-400 font-medium border-r border-[#e5e7eb] dark:border-[#2A2F3A] bg-white dark:bg-[#0B0D12]">
            Per page
          </span>
          <select
            ...
            className="pl-3 pr-8 py-1.5 text-[15px] font-bold text-[#374151] dark:text-gray-200 outline-none cursor-pointer appearance-none bg-white dark:bg-[#0B0D12] relative transition-colors focus:text-[#1a5b28] dark:focus:text-[#34d399]"
            style={{
      ...
      <div className="flex-1 flex justify-end w-full md:w-auto">
        <div className="flex items-center border border-[#e5e7eb] dark:border-[#2A2F3A] rounded-lg overflow-hidden bg-white dark:bg-[#0B0D12] shadow-xs">
          ...
          <button
            ...
            className={`px-3 py-1.5 flex items-center justify-center border-r border-[#e5e7eb] dark:border-[#2A2F3A] text-[15px] transition-colors ${currentPage === 1
